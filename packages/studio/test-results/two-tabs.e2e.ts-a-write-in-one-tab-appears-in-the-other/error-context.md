...
- Name: two-tabs.e2e.ts >> a write in one tab appears in the other
- Location: e2e/two-tabs.e2e.ts:59:1
...
Locator: getByRole('gridcell', { name: 'Set in tab A', exact: true })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('gridcell', { name: 'Set in tab A', exact: true }) with timeout 5000ms
  - waiting for getByRole('gridcell', { name: 'Set in tab A', exact: true })
